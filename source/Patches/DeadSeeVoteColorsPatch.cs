...
namespace TownOfUs
{
    ...
    public static class DeadSeeVoteColorsPatch
    {
            ...
            [HarmonyArgument(1)] int index, [HarmonyArgument(2)] Transform parent)
        {
            ...
            else if (GameOptionsManager.Instance.currentNormalGameOptions.AnonymousVotes && (!CustomGameOptions.DeadSeeRoles || DataManager.Settings.Gameplay.StreamerMode || !PlayerControl.LocalPlayer.Data.IsDead))
            {
